...
class QuizInterface():
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=true_image, relief="flat", command=self.true_pressed)
        self.true_button.grid(row=4, column=0)

        false_image = PhotoImage(file="images/false.png")
        self.false_button = Button(image=false_image, relief="flat", command=self.false_pressed)
